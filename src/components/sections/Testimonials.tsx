...
const TESTIMONIALS = [
  ...
  {
    quote:
      'AI-driven automation strengthened our operations without disrupting daily workflows.',
    role: 'Operations Head, Real Estate Organization',
    location: 'Middle East',
  },
  {
    quote:
      'The sales and incentive platform brought clarity and control across multiple regions.',
    role: 'Managing Director, Fintech Product Based Company',
    location: 'USA',
  },
]
