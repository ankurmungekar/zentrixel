...
const PRODUCTS = [
  {
    ...
    path: '/products/ai-chatbot',
  },
  {
    title: 'AI Calling Platform',
    description:
      'AI-powered voice automation platform for inbound and outbound communication.',
  ...
  },
  {
    ...
    description:
      'Automated social media engagement and moderation platform for controlled brand communication.',
    image: productSocial,
  },
  {
    title: 'Smart Facility Management Platform',
    description:
      'Intelligent facility and infrastructure management system with real-time operational visibility.',
    image: productFacility,
  },
  {
    title: 'Solid Waste Management Platform',
    description:
      'Smart waste management system designed for municipalities and large infrastructure environments.',
    image: productWaste,
  },
]
          ...
          {PRODUCTS.map((product, idx) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`absolute inset-0 flex items-end justify-center pb-8 ${isActive ? 'pointer-events-none opacity-0' : 'opacity-100 transition-opacity delay-500 duration-300'
                    }`}
                >
                ...
                <div
                  className={`absolute inset-0 flex flex-col justify-end p-8 ${isActive ? 'opacity-100 transition-opacity delay-300 duration-300' : 'pointer-events-none opacity-0'
                    }`}
                >
                  ...
                  {product.path ? (
                    ...
                    <div className="mt-5">
                      <span className="inline-block rounded-[20px] px-4 py-1.5 font-sub-heading text-sm font-semibold tracking-wider text-black backdrop-blur-sm" style={{ backgroundColor: '#FFC14B' }}>
                        COMING SOON
                      </span>
                    </div>
                  )}
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-6">
                ...
                {product.path ? (
                  ...
                  <div className="mt-4">
                    <span className="inline-block rounded-[20px] bg-white/20 px-3 py-1 font-sub-heading text-xs font-semibold tracking-wider text-white backdrop-blur-sm">
                      COMING SOON
                    </span>
                  </div>
                )}
