          ...
          <div className="flex flex-1 flex-col gap-12 lg:py-4 lg:pl-16">
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex items-center gap-3">
                <a
                  href="https://www.facebook.com/people/Zentrixel/61575541767671/"
                  target="_blank"
                ...
                <a
                  href="https://www.instagram.com/zentrixel_official?igsh=b2gycGUxNDczc2tr"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex h-[52px] w-[52px] items-center justify-center rounded-full border border-white/10 text-white transition-colors hover:bg-primary"
                ...
                <a
                  href="https://www.linkedin.com/company/107021234"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex h-[52px] w-[52px] items-center justify-center rounded-full border border-white/10 text-white transition-colors hover:bg-primary"
                  aria-label="LinkedIn"
                ...
                <a
                  href="https://www.x.com/zentrixel?s=11"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex h-[52px] w-[52px] items-center justify-center rounded-full border border-white/10 text-white transition-colors hover:bg-primary"
                  aria-label="X"
